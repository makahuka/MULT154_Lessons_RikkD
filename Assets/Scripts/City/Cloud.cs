...
public class Cloud : MonoBehaviour {
    ...
    public Vector3 sphereScaleRangeX = new Vector3(4, 8, -10);
    public Vector3 sphereScaleRangeY = new Vector3(3, 4, -20);
    public Vector3 sphereScaleRangeZ = new Vector3(2, 4, -30);
